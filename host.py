...
from you_player import YouPlayer
...
class GO:
    ...
    def judge_winner(self):
        ...
        cnt_1 = self.score(1)
        cnt_2 = self.score(2)
        if cnt_1 > cnt_2 + self.komi: return 1,cnt_1,cnt_2 + self.komi
        elif cnt_1 < cnt_2 + self.komi: return 2,cnt_1,cnt_2 + self.komi
        else: return 0,cnt_1,cnt_2 + self.komi
    ...
    def play(self, player1, player2, verbose=True):
        ...
        while 1:
            ...
            if self.game_end(piece_type):       
                result,p1_score,p2_score = self.judge_winner()
                if verbose:
                    print('Game ended.')
                    if result == 0: 
                ...
                return result,p1_score,p2_score
...
if __name__ == "__main__":
        ...
        go_game = GO(5)
        p1 = input("""\n Enter the type of player 1, player 1 goes first \n
        If you want to play, enter X \n
        computer (easy), enter E \n
        computer (hard), enter H \n
        """)
        while p1 not in ['E','e','H','h','X','x']:
            p1 = input("Enter valid input: ")
        
        p2 = input("""\n Enter the type of player 2 \n
        If you want to play with your friend, enter X \n
        computer (easy), enter E \n
        computer (difficult), enter H \n
        """)

        while p2 not in ['E','e','H','h','X','x']:
            p2 = input("Enter valid input: ")
        ...
        if p1 == 'E' or p1 == 'e':
            p1 = player3
            p1_name = 'computer(easy)'
        if p1 == 'H' or p1 == 'h':
            p1 = player1
            p1_name = 'computer(hard)'
        ...
        if p2 == 'E' or p2 == 'e':
            p2 = player3
            p2_name = 'computer(easy)'
        if p2 == 'H' or p2 == 'h':
            p2 = player1
            p2_name = 'computer(hard)'
        

        game, p1_score, p2_score = go_game.play(p1, p2, verbose=True)

        print("Player 1 went first. Player 1 gets Komi value.\n")
